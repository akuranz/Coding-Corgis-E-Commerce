				...
				<Row gutter={16}>
					...
					<Col span={8}>
						<Card bordered={false} style={{ marginBottom: 15 }}>
							<ul>
								<li>
									<strong>Language:</strong> Vanilla Javascript
								</li>
								<li>
									<strong>Price:</strong> $75/hr
								</li>
								<li>
								...
								<Button
									...
									data-id="5e9cb8646d73cb38df5a36ec"
									shape="round"
								>
									Add to Cart
								</Button>
...
export default BrowseJavascript;
